...
function MovieCard({ title, img, date, loading }: MovieCardProps) {
  ...
  // if (!loaded) {
  //   return (
  //     <div className="mx-auto max-w-[300px] aspect-[3/5] bg-transparent overflow-hidden relative"></div>
  //   );
  // }

  return (
    <div className="max-w-[300px] mx-auto aspect-[3/5] bg-transparent overflow-hidden relative group cursor-pointer">
      {!loaded && (
        <>

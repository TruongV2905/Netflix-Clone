...
function LayoutMovie() {
  return (
    <>
      <section className="relative bg-[url('https://assets.nflxext.com/ffe/siteui/acquisition/lodp/NMHP_LINK.png')] bg-cover bg-center max-w-[1250px] mx-auto h-[100px] rounded-xl overflow-hidden flex justify-between items-center gap-10 px-[30px] mb-[60px] ">
      ...
      <section className="max-w-[1250px] mx-auto p-7 rounded-xl bg-[rgba(255,255,255,0.1)] backdrop-blur-xl text-[rgb(128,128,128)] text-sm">
